...
def outdoor_forest_smooth_movement_nohover():
    # The environment can be downloaded from
    # https://drive.google.com/drive/u/2/folders/1u5teth6l4JW2IXAkZAg1CbDGR6zE-v6Z
    orig_ip = [
        [20, 50, 100],  #Player Start
        [50, 200, 100],
        [50, 100, 100],
        [20, 30, 100]
    ]
...
def initial_positions(name, initZ=-5, num_agents = 1):
    name = name+'()'
    print(num_agents)
    ...
    for agents in range(num_agents):
        ...
        for i in range(ip_each_drone):
            ...
            # z1 = 0
            z1 = 0 #initZ # in case of computervision mode
            pitch = 0
            roll = 0
